...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        'emp_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        'emp_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'emp_img' => ['type' => 'binary', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'phone' => 1,
                'dob' => '2020-12-18 07:54:38',
                'emp_img' => 'Lorem ipsum dolor sit amet',
            ],
        ];
        parent::init();
    }
